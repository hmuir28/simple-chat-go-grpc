...
const (
	...
	GreetService_SayHelloBidrectionalStreaming_FullMethodName = "/greet_service.GreetService/SayHelloBidrectionalStreaming"
)
...
func (c *greetServiceClient) SayHelloBidrectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidrectionalStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_SayHelloBidrectionalStreaming_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
